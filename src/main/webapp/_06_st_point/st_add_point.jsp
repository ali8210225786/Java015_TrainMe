...
<body>
	<div class="container">
		...
		<div class="ccle">
			<div onclick="alertCookie(2000)" >
				支付2000元<br />
				<p class="text1">儲值2000點</p>
			</div>
			<div onclick="alertCookie(3000)">
				支付3000元<br />
			...
			<p class="description">Lorem ipsum dolor sit amet consectetur
				...
				<script>
					...
					function alertCookie(value){
						...
						// alert(value)
						window.location.assign("st_checkout.jsp")
